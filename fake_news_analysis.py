...
# Set up logging
logging.basicConfig(filename='fake_news_longest_depth_files.log', level=logging.INFO, 
...
# Function to read the top 3 files from fake_news_longest_depth_files.log
...
for key, directory in directories.items():
    ...
    matched_descriptions = match_descriptions('fake_news_longest_depth_files.log', tweet_descriptions_file_path)
...
print("Top 3 files with the longest depth logged in 'fake_news_longest_depth_files.log' and plots created.")
